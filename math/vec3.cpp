...
{
    return sqrt((a.components[0]-b.components[0])*(a.components[0]-b.components[0])+(a.components[1]-b.components[1])*(a.components[1]-b.components[1])+(a.components[2]-b.components[2])*(a.components[2]-b.components[2]));
}
